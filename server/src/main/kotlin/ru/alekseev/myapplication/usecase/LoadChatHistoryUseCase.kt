 ...
 * Converts database messages to DTOs that can be sent to the client.
 */
class LoadChatHistoryUseCase(
     ...
     * Each database message produces both a user message and an assistant message.
     *
     * @param userId The user identifier
     * @return List of ChatMessageDto objects representing the conversation history
     */
    suspend operator fun invoke(userId: String): List<ChatMessageDto> {
